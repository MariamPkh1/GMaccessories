    ...
    <nav className="lg:hidden border-t border-outline-variant bg-white shadow-sm">
      <div className="px-6 py-3 flex flex-col">
        {links.map((link) =>
          ...
          // become a wall of links on a small screen. Matched on the stable id,
          // not the label, which now varies by language.
          link.id === 'catalog' ? (
            <div key={link.id}>
        ...
        {/* No language switcher here: it lives in the navbar at every width, so
            duplicating it inside this panel would show two of them. */}
